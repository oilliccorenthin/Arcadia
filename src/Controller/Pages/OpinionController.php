...
class OpinionController extends AbstractController
{
    ...
    #[Route('/admin/opinion', name: 'app_opinion_index', methods: ['GET'])]
    ...
    #[Route('/admin/opinion/{id}/edit', name: 'app_opinion_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/opinion/{id}', name: 'app_opinion_delete')]
